...
//         for (int i = 0; i<90;i++){
//             System.out.println("hello" + i + "  " + deck.draw()); 
//      }
...
// System.out.println(p1.discardCard(card, pile2));
// System.out.println(p1);
// System.out.println(pile2);
p1.returnCard(card, deck2);
System.out.println(deck2.size());
int index = deck2.size();
for (int i = 0; i<index;i++){
    System.out.println("hello" + i + "  " + deck2.draw()); 
}
}
}